    ...
    try:
        ...
        if playlists_to_remove:
            for playlist in playlists_to_remove:
                ...
                emit_log_message(f"Removing playlist: {playlist} from the database")
        ...
        emit_log_message(f"Adding {len(playlist_tracks_dict)} audio playlists to the database")
        ...
        emit_log_message(f"Adding {len(video_playlists)} video playlists to the database")
        ...
        emit_log_message(f"Adding {len(photo_playlists)} photo playlists to the database")
        ...
        if playlist_videos_dict:
            for db_playlist, items in playlist_videos_dict.items():
                ...
                emit_log_message(f"Adding playlist: {db_playlist.title}")
